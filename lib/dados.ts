...
export const livrosExemplo: Livro[] = [
  {
    ...
    urls: {
      ...
      sinopse: 'Uma obra referencial no estudo de sistemas de controle moderno.',
    },
...
export const softwaresExemplo: Software[] = [
  {
    ...
    recursos: {
      suportaPlugins: true,
      scriptable: true,
      documentsaoUrl: 'https://www.mathworks.com/help/',
      comunidadeSize: 'grande',
    },
    estatisticas: {
      downloads: 5000,
      versaoAtual: '2024a',
    ...
    etapas: [
      {
        ...
        descricao: 'Revisão de literatura sobre robótica e visão computacional.',
        duracao: '2 meses',
...
export const categoriasLivros: ItemMenu[] = [
  ...
  },
  {
    ...
    descricao: 'Livros sobre linguagens de programação e desenvolvimento de software.',
  },
  {
    titulo: 'Engenharia',
    href: '/biblioteca/livros/engenharia',
    descricao: 'Livros sobre diversos ramos da engenharia e aplicações profissionais.',
  },
  {
...
export const recursosHome: Recurso[] = [
  ...
  },
  {
    ...
    descricao: 'Projetos reais com construção passo a passo e decisões técnicas.',
    href: '/projetos',
  },
  {
