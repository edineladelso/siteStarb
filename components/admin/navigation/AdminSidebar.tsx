...
export function AdminSidebar() {
  ...
  return (
    <aside
      className={`fixed top-0 left-0 z-40 h-screen border-r border-slate-200 bg-white transition-all duration-300 ${
        ...
        <div className="space-y-1 border-t border-slate-200 pt-4">
          {settingsItems.map((item) => (
            <Link
              key={item.href}
              href={item.href}
              className="flex items-center gap-3 rounded-lg px-3 py-2.5 text-slate-700 transition-colors hover:bg-slate-50"
            >
