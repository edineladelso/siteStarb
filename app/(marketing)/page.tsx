                  ...
                  {imgCarousel.map((item, index) => (
                    <CarouselItem key={index}>
                      <div className="relative aspect-4/3">
                        {/* Se você tiver imagens reais, use Next Image */}
                        <Image
                          src={item.src}
                          alt={item.alt}
                          fill
                        ...
                        {/* Placeholder temporário com gradientes diferentes */}
                        {/* <div className={`w-full h-full flex items-center justify-center ${
                          index === 0 ? 'bg-linear-to-br from-blue-400 via-indigo-500 to-purple-600' :
                          index === 1 ? 'bg-linear-to-br from-indigo-400 via-purple-500 to-pink-600' :
                          'bg-linear-to-br from-cyan-400 via-blue-500 to-indigo-600'
                        }`}>
                          <div className="text-center text-white p-8">
                            <div className="text-white/90 mb-4">
                              {index === 0 ? <BookIcon /> : index === 1 ? <CodeIcon /> : <AIIcon />}
                            </div>
                            <p className="text-2xl font-bold">{item.alt}</p>
                            <p className="text-sm opacity-90 mt-2">Conteúdo de Alta Qualidade</p>
                          </div>
                        </div> */}
